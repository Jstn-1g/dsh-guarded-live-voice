...
`;
		...
		*/
		...
		function voiceProviderDisclosure(provider) {
			if (provider === "qwen") return {
				provider,
				disclosure: QWEN_DISCLOSURE
			};
			if (provider === "synthetic-demo") return {
				provider,
		...
		function isVoiceProviderId(value) {
			return value === "qwen" || value === "synthetic-demo";
		}
		function hasExactDisclosure(value, expected) {
			return isRecord(value) && hasOnlyKeys(value, DISCLOSURE_KEYS) && DISCLOSURE_KEYS.every((key) => value[key] === expected[key]);
		}
		...
		function parseServerControl(raw) {
			...
			if (parsed.type === "ready") {
				if (!hasOnlyKeys(parsed, [
					...
					"model",
					"authority"
				]) || !isValidWireId(parsed.sessionId) || !isValidWireId(parsed.workspaceId) || !isVoiceProviderId(parsed.provider) || !validDisplayString(parsed.model, 128) || parsed.authority !== "proposal-only") throw new GuardedVoiceError("invalid-message", "ready event is invalid");
				return {
					v: 1,
					type: "ready",
					sessionId: parsed.sessionId,
		...
		var VoiceClientController = class {
			...
			outputBytes = 0;
			composerBinding;
			sessionMounts = /* @__PURE__ */ new Map();
			pendingSessionStops = /* @__PURE__ */ new Map();
			constructor(options) {
				this.options = options;
			...
			*/
			mountSession = (sessionId) => {
				...
				return () => {
					...
					queueMicrotask(() => {
						if (this.disposed || this.pendingSessionStops.get(sessionId) !== pending || this.sessionMounts.has(sessionId)) return;
						this.pendingSessionStops.delete(sessionId);
						this.stop(sessionId);
					});
				};
			...
			beginCapture(sessionId) {
				...
				try {
					...
					if (provider === void 0) throw new Error("voice provider disclosure is unavailable");
			...
			received(active, message) {
				...
				try {
					...
					if (event.type === "ready") {
						const disclosure = this.snapshot.disclosure;
						if (this.snapshot.phase !== "authorizing" || disclosure === void 0 || event.sessionId !== active.sessionId || event.workspaceId !== disclosure.workspaceId || event.provider !== disclosure.provider) throw new Error("voice ready event does not match the accepted binding");
						this.publish({
							phase: "ready",
							sessionId: active.sessionId,
							disclosure,
		...
		//#endregion
		//#region src/client/synthetic-demo-capture.ts
		const DEMO_INPUT_SAMPLE_RATE = 16e3;
		const DEMO_INPUT_DURATION_MS = 100;
		const DEMO_INPUT_FREQUENCY_HZ = 440;
		const DEMO_INPUT_AMPLITUDE = 4096;
		function syntheticInputPcm16() {
			const samples = Math.floor(DEMO_INPUT_SAMPLE_RATE * DEMO_INPUT_DURATION_MS / 1e3);
			const bytes = new Uint8Array(samples * 2);
			const view = new DataView(bytes.buffer);
			for (let index = 0; index < samples; index += 1) {
				const sample = Math.round(Math.sin(2 * Math.PI * DEMO_INPUT_FREQUENCY_HZ * index / DEMO_INPUT_SAMPLE_RATE) * DEMO_INPUT_AMPLITUDE);
		...
		*/
		var SyntheticDemoCapture = class {
			handlers;
			started = false;
			stopped = false;
			...
			start() {
				if (this.started || this.stopped) return Promise.reject(/* @__PURE__ */ new Error("synthetic demo capture cannot be restarted"));
				this.started = true;
		...
		function sessionIdOf(props) {
			if (typeof props.sessionId !== "string" || props.sessionId.length === 0) throw new Error("DSH Live Voice requires a strict Session-scoped slot identity");
		...
		function VoicePanel(props) {
			const { useVoice, startVoice, acceptDisclosure, stopVoice, beginVoiceCapture, finishVoiceCapture, getVoiceSnapshot, isComposerBindingCurrent, claimVoiceDraftHandoff, inputActions, input, t } = props;
			const sessionId = sessionIdOf(props);
			const voice = useVoice((snapshot) => snapshot);
			...
			if (voice.phase === "ready") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: voice_module_css_default.detail,
						children: t(syntheticDemo ? "panel.demoReadyDetail" : "panel.readyDetail")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							children: t(syntheticDemo ? "panel.demoRecord" : "panel.record")
						})]
					})
				]
			});
			if (voice.phase === "preparing-audio") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: voice_module_css_default.panelHeading,
						children: t(syntheticDemo ? "panel.demoPreparingAudio" : "panel.preparingAudio")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: voice_module_css_default.detail,
						children: t(syntheticDemo ? "panel.demoPermissionDetail" : "panel.permissionDetail")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: voice_module_css_default.secondaryButton,
			...
			if (voice.phase === "recording") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: voice_module_css_default.panelHeading,
						children: t(syntheticDemo ? "panel.demoRecording" : "panel.recording")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: voice_module_css_default.detail,
						children: t(syntheticDemo ? "panel.demoRecordingDetail" : "panel.recordingDetail")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: voice_module_css_default.actions,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							children: t(syntheticDemo ? "panel.demoFinishTurn" : "panel.finishTurn")
						})]
					})
				]
			});
			if (voice.phase === "responding" || voice.phase === "completed") {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: voice_module_css_default.panelHeading,
							children: t(voice.phase === "completed" ? "panel.completed" : syntheticDemo ? "panel.demoResponding" : "panel.responding")
						}),
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: t(syntheticDemo ? "panel.demoPreview" : "panel.preview")
					}),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dl", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("panel.retention") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t(syntheticDemo ? "panel.demoRetention" : "panel.retentionUnknown") })] }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("panel.milestone") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t(syntheticDemo ? "panel.demoMilestone" : "panel.noAudio") })] })
						]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		//#endregion
		//#region src/client/VoiceSeats.tsx
		/** Stop the exact lifecycle when this strict session-scoped seat unmounts. */
		function useVoiceSessionSeat(props) {
			const { mountVoiceSession } = props;
			const sessionId = sessionIdOf(props);
			(0, react.useLayoutEffect)(() => mountVoiceSession(sessionId), [mountVoiceSession, sessionId]);
		}
		/** Session-scoped compact control with deterministic unmount cleanup. */
		function VoiceControlSeat(props) {
			useVoiceSessionSeat(props);
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(VoiceControl, { ...props });
		}
		/** Session-scoped disclosure panel with deterministic unmount cleanup. */
		function VoicePanelSeat(props) {
			useVoiceSessionSeat(props);
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(VoicePanel, { ...props });
		}
		//#endregion
		...
		function apply(ctx) {
			...
			const controller = new VoiceClientController({
				...
				captureFactory: (handlers, provider) => provider === "synthetic-demo" ? new SyntheticDemoCapture(handlers) : new BrowserPcmCapture(handlers)
			});
			const injected = () => ({
