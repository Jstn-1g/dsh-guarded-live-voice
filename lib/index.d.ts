...
declare class VoiceSessionManager {
  ...
  constructor(authority: AuthorityGuard, consents: ConsentChallenges, authorizeProvider: AuthorizeProvider);
...
interface ConsentRequiredEvent {
  readonly v: typeof WIRE_VERSION;
